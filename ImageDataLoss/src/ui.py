...
class ImageApp:
    def __init__(self, root):
        ...
        # Variables to hold image paths and processing parameters
    ...
    def create_widgets(self):
        ...
        # Compression and Saving Options
    ...
    def save_image(self):
        ...
        if save_path:
            temp_path = "temp_image.png"  # Temporary save path for processed image
            cv2.imwrite(temp_path, self.processed_image)  # Save the OpenCV processed image
