...
from tests import read_image, create_folder, write_image, box_blur, write_image_with_quality, IMG_FLOWER_1920
...
if __name__ == '__main__':
    compression_impact_on_blur(image_path=IMG_FLOWER_1920,
                               qualities=[90, 70, 50],
                               ksize=11)
